...
<p align="center">
  <sub>matic · l2 bridge · erc-20</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>PolyWallet</code> &nbsp;·&nbsp; <code>polywallet</code>
</p>
...
Polygon wallet — MATIC sends, ERC-20 on Polygon, bridge status stubs.

L2 users search polygon-wallet more than chain brand names.
...
```bash
dotnet restore polygon-wallet.slnx
dotnet build polygon-wallet.slnx -c Release
dotnet test polygon-wallet.slnx -c Release
```
